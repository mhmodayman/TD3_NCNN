...
class Actor(nn.Module):
    def __init__(self, state_size, action_size, max_action, fc1=256, fc2=256):
        ...
        #Layer 1
        self.fc1 = nn.Linear(state_size, fc1, bias=True)
        #Layer 2
        self.fc2 = nn.Linear(fc1, fc2, bias=True)
        #Layer 3
        self.mu = nn.Linear(fc2, action_size, bias=True)
...
class Critic(nn.Module):
    def __init__(self, state_size, action_size, fc1=256, fc2=256):
        ...
        #Layer 1
        self.l1 = nn.Linear(state_size + action_size, fc1, bias=True)
        #Layer 2
        self.l2 = nn.Linear(fc1, fc2, bias=True)
        #Output layer
        self.l3 = nn.Linear(fc2, 1, bias=True)#Q-value

        #---------Q2 architecture---------

        #Layer 1
        self.l4 = nn.Linear(state_size + action_size, fc1, bias=True)
        #Layer 2
        self.l5 = nn.Linear(fc1, fc2, bias=True)
        #Output layer
        self.l6 = nn.Linear(fc2, 1, bias=True)#Q-value
