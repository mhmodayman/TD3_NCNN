...
nvidia_model = load_model(record_saving_path + '/model_dxdy_0.h5')
...
try:
    ...
    print('change init_weights(self, layer, gain=1) from case 2 to case until you have a saved checkpoint, '
